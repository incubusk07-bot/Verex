 ...
 *
 * Two palettes share one shape (ThemeColors): `lightColors` (default, identical to
 * the original design) and `darkColors` (vault-at-night). Components consume the
 * active palette via useTheme()/useThemedStyles() from providers/ThemeProvider.
 */
const light = {
  bg: "#F7F5F0",
  surface: "#FFFFFF",
...
/** Vault-at-night palette — same brand golds, deep charcoal surfaces. */
...
/** Back-compat static palette (light). New code should use useTheme(). */
