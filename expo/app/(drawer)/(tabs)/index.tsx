...
const getVerdictPalette = (colors: ThemeColors) => ({
  dot: {
    likely_original: colors.success,
    likely_counterfeit: colors.error,
    inconclusive: colors.amber,
  } as Record<VerdictKind, string>,
  bg: {
    likely_original: colors.successPale,
    likely_counterfeit: colors.errorPale,
    inconclusive: colors.amberPale,
  } as Record<VerdictKind, string>,
  text: {
    likely_original: colors.successDeep,
    likely_counterfeit: colors.errorDeep,
    inconclusive: colors.amberDeep,
  } as Record<VerdictKind, string>,
});
...
export default function HomeScreen() {
  ...
  const verdictPalette = useMemo(() => getVerdictPalette(colors), [colors]);
  const {
    hydrated,
    onboarded,
    portfolioValue,
              ...
              {scans.slice(0, 8).map((scan: ScanAnalysis) => (
                ...
                >
                  ...
                  <View style={styles.recentInfo}>
                    ...
                    <View style={[styles.recentVerdictRow, { backgroundColor: verdictPalette.bg[scan.verdict] }]}>
                      <View style={[styles.verdictDot, { backgroundColor: verdictPalette.dot[scan.verdict] }]} />
                      <Text
                        style={[styles.recentVerdict, { color: verdictPalette.text[scan.verdict] }]}
                        numberOfLines={1}
                      >
