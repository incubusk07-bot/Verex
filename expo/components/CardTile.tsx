...
import { Layers, ShieldAlert, ShieldCheck } from "lucide-react-native";
  ...
  return (
    ...
    >
      <View style={styles.imageBox}>
        ...
        {item.verdict === "likely_original" ? (
          <View style={[styles.verdictBadge, styles.verdictPass]}>
            <ShieldCheck size={11} color="#FFFFFF" />
            <Text style={styles.verdictText}>Authentic</Text>
          </View>
        ) : item.verdict === "likely_counterfeit" ? (
          <View style={[styles.verdictBadge, styles.verdictFail]}>
            <ShieldAlert size={11} color="#FFFFFF" />
            <Text style={styles.verdictText}>Failed</Text>
          </View>
        ) : null}
      </View>
